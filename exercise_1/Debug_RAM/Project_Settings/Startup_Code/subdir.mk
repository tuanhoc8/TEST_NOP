...
S_UPPER_SRCS += \
../Project_Settings/Startup_Code/Initialize_Stack.S \
../Project_Settings/Startup_Code/startup_S32K144.S 

OBJS += \
./Project_Settings/Startup_Code/Initialize_Stack.o \
...
Project_Settings/Startup_Code/%.o: ../Project_Settings/Startup_Code/%.S
	...
	arm-none-eabi-gcc "@Project_Settings/Startup_Code/Initialize_Stack.args" -o "$@" "$<"
