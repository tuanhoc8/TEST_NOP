...
//	volatile uint32_t Reserved8[32];
...
#define FlexCAN_0									((FlexCAN_Typedef *)FlexCAN0_BASE_ADDRESS)
#define FlexCAN_1									((FlexCAN_Typedef *)FlexCAN1_BASE_ADDRESS)
#define FlexCAN_2									((FlexCAN_Typedef *)FlexCAN2_BASE_ADDRESS)
...
#define SCG_SPLLDIV_1_DIV1																			(1<<0)
#define SCG_SPLLDIV_1_DIV2																			(2<<0)
#define SCG_SPLLDIV_1_DIV4																			(3<<0)
#define SCG_SPLLDIV_1_DIV8																			(4<<0)
#define SCG_SPLLDIV_1_DIV16																			(5<<0)
#define SCG_SPLLDIV_1_DIV32																			(6<<0)
#define SCG_SPLLDIV_1_DIV64																			(7<<0)
...
#define SCG_SIRCDIV_1_DIV1																			(1<<0)
#define SCG_SIRCDIV_1_DIV2																			(2<<0)
#define SCG_SIRCDIV_1_DIV4																			(3<<0)
#define SCG_SIRCDIV_1_DIV8																			(4<<0)
#define SCG_SIRCDIV_1_DIV16																			(5<<0)
#define SCG_SIRCDIV_1_DIV32																			(6<<0)
#define SCG_SIRCDIV_1_DIV64																			(7<<0)
...
#define PCC_FTM_CGC																							(1U<<30)
#define PCC_FlexCAN_CGC                                         (1U<<30)
...
#define PCC_FTM_PCS_SOSCDIV1																	  (1<<24)		
#define PCC_FTM_PCS_SIRCDIV1																	  (2<<24)
#define PCC_FTM_PCS_FIRCDIV1																	  (3<<24)
#define PCC_FTM_PCS_SPLLDIV1																	  (6<<24)
...
/*                                                                            */
/******************************************************************************/
/******************** Bit definition for FTM  Register   **********************/
#define FTM_MOD_FTMEN																													(1u<<0)

#define FTM_COMBINE_COMBINE(X)																								(1<<(0+4*X))
#define FTM_COMBINE_COMP(X)																										(1<<(1+4*X))
#define FTM_COMBINE_DECAPEN(X)																								(1<<(2+4*X))
#define FTM_COMBINE_DECAP(X)																									(1<<(3+4*X))
#define FTM_COMBINE_DTEN(X)																					  			  (1<<(4+4*X))
#define FTM_COMBINE_SYNCEN(X)																									(1<<(5+4*X))
#define FTM_COMBINE_FAULTEN(X)																					  		(1<<(6+4*X))
#define FTM_COMBINE_MCOMBINE(X)																								(1<<(7+4*X))



#define FTM_SC_CLK_SYSTEM_CLK																									(1u<<3)
#define FTM_SC_CLK_FIXFREQ_CLK																								(2u<<3)
#define FTM_SC_CLK_EXTERN_CLK																									(3u<<3)
...
#define FTM_CnSC_DMA																													(1u<<0)
#define FTM_CnSC_ICRST																												(1u<<1)
...
#define FTM_CnSC_TRIGMODE																											(1u<<8)
#define FTM_CnSC_CHIS 																												(1u<<9)
#define FTM_CnSC_CHOV   																											(1u<<10)
#define FTM_DEADTIME_DTPS_DIV1																								(0<<6)
#define FTM_DEADTIME_DTPS_DIV4																								(2<<6)
#define FTM_DEADTIME_DTPS1_DIV6																								(3<<6)
#define FTM_DEADTIME_DTVAL(X)																									(X<<0)
#define FTM_SC_PWMEN(X)																												(1U<<(X+16))
#define FTM_CnV_VAL(X)																												(X-1)
#define FTM_SC_CPWMS																													(1u<<5)
#define FTM_SC_PS(X)																													(X<<0)
#define FTM_QDCTRL_QUADEN																											(1<<0)
#define FTM_SC_TOIE																														(1<<8)
#define FTM_SC_TOF																														(1u<<9)
#define FTM_QDCTRL_QUADIR																											(1u<<2)
...
/*                                                                            */
/******************************************************************************/
/********************  Bit definition for FLEXCAN register  ********************/

#define FlexCAN_MCR_MDIS																													(1u<<31)
#define FlexCAN_CTRL1_CLKSRC_SOSCDIV2																							(0u<<13)
#define FlexCAN_CTRL1_CLKSRC_SYSCLK																							  (1u<<13)
#define FlexCAN_CTRL1_PRESDIV(X)																									((X)<<24)
#define FlexCAN_CTRL1_PSEG2(X)																									  (X<<16)

#define FlexCAN_CTRL1_PSEG1(X)																								    (X<<19)
#define FlexCAN_CTRL1_PROPSEG(X)																									(X<<0)
#define FlexCAN_CTRL1_RJW(X)																											(X<<22)
#define FlexCAN_CTRL1_SMP																													(1<<7)
#define FlexCAN_MCR_FRZACK																												(1u<<24)
#define FlexCAN_MCR_NOTRDY																												(1u<<27)
#define FlexCAN_WMBn_ID_ID																												(0x1FFFFFFFu)
#define FlexCAN_WMBn_CS_DLC																												(0xF<<16)
